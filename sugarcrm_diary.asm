...
;Throughout the day we discussed the business processes more in details;
;Now I am working on the House and Equipment modules
;I need to find a useful information about module relations and SubPanels

;Connected to github and creted three repository (sugarcrm) 
;and connected to 2 existing ones (phpunit, sugarcrm_dev)
;learned more about php unit testing:
http://www.phpunit.de/manual/current/en/

17.20
:Tasks
;1 write to sugarcrm about chat

"05 DEC 2012"

13.14
;Finished PHPUnit testing of sugarcrm_dev directory

;working on the service -> address -> building -> equipment connection


;working with street_id
;- it is an int automatically generated by sugarcrm


15.43
;moved working on sugarcrm_dev 6.5.8


16.54
;installed russian language pack
;moved the hooks from Lead module in home directory to root
