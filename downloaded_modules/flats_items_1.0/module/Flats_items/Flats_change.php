...
class Flats_change extends SugarBean {
	...
	function build_generic_where_clause ($the_query_string)
	{
		...
		array_push($where_clauses, " flats_changes.user_name LIKE '$the_query_string%' ");
